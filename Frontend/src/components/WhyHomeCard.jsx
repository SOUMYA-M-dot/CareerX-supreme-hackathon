...
const WhyHomeCard = ({ logo, head, para }) => {
  return (
    <div className="bg-neutral-400/20 text-neutral-300 backdrop-blur-[1px] border border-neutral-400/20 rounded-2xl p-6 w-[21.5vw] h-[20vw] hover:shadow-xl transition-all duration-300 text-center">
