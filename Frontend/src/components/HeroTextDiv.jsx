  ...
  return (
    <div className="flex flex-col items-center gap-1 mt-[8vw]">
        <h1 className="hero-text text-[13vw] lg:text-[5.5vw] text-center leading-[14vw] lg:leading-[5.5vw]">
          Your Friendly <span className="inline text-[#016CFF]">Guide</span> to<br className="hidden lg:block" /> the <span className="inline text-[#016CFF]">Career</span> World
        </h1>
        ...
        <button
          className="bg-blue-600/80 text-neutral-300 hover:bg-blue-600 hover:text-white backdrop-blur-[1px] border rounded-full border-neutral-400/20 px-5 mt-2 lg:text-[1.2vw] lg:px-8 lg:py-1"
          onClick={() => {
            navigate("/register");
          }}
        >
