  ...
  return (
    <div className="flex flex-col w-[46vw] lg:w-[23vw] min-h-[50vw] lg:min-h-[30vw] bg-neutral-400/20 text-neutral-300 backdrop-blur-[1px] border rounded-xl border-neutral-400/20 p-[2vw] lg:p-[1vw] mb-[2.5vw]">
      ...
      <div className="image flex justify-between my-[4vw] lg:my-[.8vw] items-center">
        <div className="h-[13vw] lg:h-[5.3vw] overflow-hidden aspect-square rounded-full flex items-center justify-center border lg:border-[#5d5d5d]">
          <img
      ...
      <div className="mid-content flex flex-col">
        <div className="head lg:my-[.5vw]">
          <h4 className="hero-text font-bold text-[5.5vw] lg:text-[2vw] leading-none min-h-[13vw] lg:min-h-[2.2vw]">
            {desg}
          </h4>
        ...
        <div className="mid min-h-[35vw] lg:min-h-[8vw] flex flex-col justify-start lg:mt-3">
          <ul className="text-neutral-300 grid grid-cols-2 lg:grid-cols-3 gap-1">
            {skill.map((s, i) => (
              <li key={i} className="text-[2.7vw] lg:text-[1vw] h-[5vw] lg:h-[2vw] min-w-[16vw] lg:min-w-[1vw] flex items-center justify-center bg-neutral-400/20 hover:bg-blue-600/80 transition-all text-neutral-300 backdrop-blur-[1px] border rounded-full border-neutral-400/20 cursor-pointer">
                <h6>{s}</h6>
              </li>
            ))}
          </ul>
      ...
      {/* Divider */}
      <div className="line w-full h-[.2vw] lg:h-[.1vw] bg-[#666666] my-[3vw] lg:my-[1vw] rounded-full"></div>

      {/* Bottom */}
      <div className="bottom-part flex justify-between items-center">
        <div>
          <h4 className="text-[4vw] lg:text-[1.3vw]">
            $ {pay}k <span className="hidden lg:inline">/month</span>
          </h4>

          <div className="hidden lg:flex relative items-center">
            <img
              className="h-4 aspect-square absolute left-3"
              src="../src/assets/images/google.png"
              alt=""
            />{" "}
            <img
              className="h-4 aspect-square absolute left-2"
              src="../src/assets/images/twitter.png"
              alt=""
            />{" "}
            <img
              className="h-4 aspect-square absolute"
              src="../src/assets/images/dribble.png"
              alt=""
            />
        ...
        <div
          className="w-[45%] lg:w-[35%] h-[6vw] lg:h-[2vw] bg-blue-600/80 flex items-center justify-center rounded-full lg:rounded-xl text-[3vw] lg:text-[1.2vw]"
          onClick={() => navigate(`/career-wrapper/roadmap?field=${field}`)}
        >
          <h4>Explore</h4>
